...
% Run the analysis
for i =1:noSteps
    [x{i},y{i},u{i},v{i}, typeVector{i}, correlationMap{i}] = piv_analysis(imFiles(1).folder, imFiles(imRelation(i,1)).name, imFiles(imRelation(i,2)).name,p,s,pivOptions.noCores,false);
end
